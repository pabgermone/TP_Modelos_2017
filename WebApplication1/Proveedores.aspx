<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="WebApplication1.Proveedores" %>
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="rptBandeja" >
                                <ItemTemplate>
                                    <tr>
                                         <td>
                                            <asp:Label ID="rptBandeja_lblSector" runat="server" Text='<%# Eval("idProveedor")%>'></asp:Label>
                                        </td>
                                          <td>
