          ...
          <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="Productos.aspx"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Productos</a></li>                        
                        <li><a href="Contacto.aspx"><i class="fa fa-inbox" aria-hidden="true"></i> Contacto</a></li>
